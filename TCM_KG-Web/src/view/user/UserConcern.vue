      ...
      <div class="detail">
        ...
        <el-row class="users">
          ...
          <el-col :span="19">
            ...
            <div v-else><el-empty><h3>没有关注用户</h3></el-empty></div>
          </el-col>
        </el-row>
      </div>
    </el-main>
...
import {showConcerns} from "@/api/user";
import {Avatar, UserFilled} from "@element-plus/icons-vue";
import SystemFooter from "@/components/footer/SystemFooter.vue";

export default {
  name: "UserConcern",
  components: {SystemFooter, UserFilled, Avatar, SystemHeader, UserHeader, UserItem},
  data() {
    return{
  ...
  created() {
    showConcerns(this.id, this.page).then(res=>{
