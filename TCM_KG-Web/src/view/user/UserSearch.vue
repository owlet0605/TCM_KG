  ...
  <el-container>
    ...
    <el-main>
      <div class="detail">
        ...
        <div v-else class="articles"><el-empty><h3>找不到相关文章</h3></el-empty></div>
      </div>>
    </el-main>
    <el-footer>
      <SystemFooter/>
...
import {articleSearchOnUser} from "@/api/article";
...
export default {
  ...
  created() {
    articleSearchOnUser(this.id, this.str, this.page).then(res=>{
